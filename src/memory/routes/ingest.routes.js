...
const { verifyIntelligenceIngest } = require('../../middleware/webhookVerification');

// Phase 1.5C: Require WEBHOOK_SECRET on all ingest routes
router.use(verifyIntelligenceIngest);
