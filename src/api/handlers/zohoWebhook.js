...
async function handleNewLead(webhookData) {
  ...
  // Trigger AI pipeline (lead_memory, qualification, decisions, workflow, learning)
  ZohoIngestor.ingestLead(webhookData).catch(e => logger.error('ZohoIngestor error', { error: e.message }));
