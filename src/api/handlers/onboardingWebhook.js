...
// Phase 3.2: Auto-link qualification prediction outcome (fire-and-forget)
setImmediate(() => PredictionPublisher.autoLinkOutcome({
module: 'qualification_engine',
lead_id: lead.id,
outcome_type: 'onboarding_completed',
outcome_value: { onboarded_at: new Date().toISOString(), source: 'onboarding_webhook', zoho_lead_id: lead.zoho_lead_id || null },
is_correct: true,
accuracy_score: 1.0,
notes: 'Lead successfully onboarded'
}).catch(e => logger.error('[OutcomeLinker] onboarding_completed failed:', e.message)));
